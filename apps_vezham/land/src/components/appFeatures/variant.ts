...
const tva = tv({
  slots: {
    ...
    featureIcon: 'relative mb-4 px-10 text-neutral-600 dark:text-neutral-400',
    featureTitleWrapper: 'relative mb-2 px-10 text-lg font-bold',
    ...
    featureDescription:
      'relative max-w-xs px-10 text-sm text-neutral-600 dark:text-neutral-300',
