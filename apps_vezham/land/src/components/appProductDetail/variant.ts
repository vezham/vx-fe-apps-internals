// product-detail-page/variant.ts
...
const tva = tv({
  slots: {
    ...
    headerInner:
      'border-divider bg-content1 mx-auto mt-20 flex items-center justify-between border-b px-2 py-4 md:px-6',
    headerTitle: 'text-md ml-2 font-bold md:text-xl',
    mainContainer: 'container mx-auto px-4 py-4',
    section: 'mb-4 p-4',
    overviewTitle: 'mb-4 text-3xl font-bold',
    overviewDescription: 'text-default-400 text-lg',
    ...
    featureIcon: 'relative mb-4 px-6 text-neutral-600 dark:text-neutral-400',
    featureTitleWrapper: 'relative mb-2 px-6 text-lg font-bold',
    featureTitleHighlight:
      'absolute inset-y-0 left-0 h-6 w-1 origin-center rounded-tr-full rounded-br-full bg-neutral-300 transition-all duration-200 group-hover/feature:h-12 group-hover/feature:bg-[#a91d44] dark:bg-neutral-700 dark:group-hover/feature:bg-[#df4861]',
    featureTitle:
      'inline-block text-neutral-800 transition duration-200 group-hover/feature:translate-x-2 dark:text-neutral-100',
    featureDescription:
      'relative max-w-xs px-6 text-sm text-neutral-600 dark:text-neutral-300',
