  ...
  social: [
    {
      ...
      icon: (props: SocialIconProps) =>
        React.createElement(Icon, { ...props, icon: 'fontisto:linkedin' })
    },
    {
      name: 'X',
      href: '#',
      icon: (props: SocialIconProps) =>
        React.createElement(Icon, { ...props, icon: 'prime:twitter' })
    },
    {
      name: 'Facebook',
      href: '#',
      icon: (props: SocialIconProps) =>
        React.createElement(Icon, { ...props, icon: 'fontisto:facebook' })
    },
    {
      name: 'Instagram',
      href: '#',
      icon: (props: SocialIconProps) =>
        React.createElement(Icon, { ...props, icon: 'fontisto:instagram' })
    },
    {
      name: 'GitHub',
      href: '#',
      icon: (props: SocialIconProps) =>
        React.createElement(Icon, { ...props, icon: 'fontisto:github' })
    }
  ]
}
