  ...
  return (
    <div className="bg-background text-foreground flex min-h-screen flex-col scroll-smooth">
      ...
      <div className="flex flex-1">
        ...
        <div
          className={`${isMobileSidebarVisible ? 'translate-x-0' : '-translate-x-full'} bg-content1 border-divider fixed top-0 bottom-0 left-0 z-40 flex h-full w-64 flex-col overflow-hidden border-r transition-transform duration-300 ease-in-out lg:sticky lg:top-0 lg:h-screen lg:translate-x-0`}>
